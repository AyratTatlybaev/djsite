...
class Report(models.Model):
    ...
    report_year = models.DecimalField(max_digits=4, decimal_places=0, default=2022, verbose_name='Year')  # Год отчёта
    report_month = models.DecimalField(max_digits=2, decimal_places=0,default=1, verbose_name='Month')  # Месяц отчёта
    report_create = models.DateTimeField(auto_now_add=True, verbose_name="Time create")
    report_update = models.DateTimeField(auto_now=True, verbose_name="Time update")
    # Имя создателя отчёта
    author_name = models.CharField(max_length=255, default='', verbose_name="Author")
